...
class JSONMemoryConfig(object):
    ...
    def __init__(self, in_json):
        ...
        self.provisioned_device_max_app_keys = int(j['Provisioned Device Max Appkeys'], 0)
...
def calculate_memory_usage(dcd, memcfg, memsizes):
    ...
    total += memcfg.node_max_friendships * memsizes['friendship']
    ...
    total += memcfg.provisioned_devices * (memsizes['prv_ddb_entry_base'] + memcfg.provisioned_device_max_net_keys * memsizes['prv_ddb_entry_per_node_netkey'] + memcfg.provisioned_device_max_app_keys * memsizes['prv_ddb_entry_per_node_appkey'])
    total += memcfg.node_friend_max_subscription_list * memsizes['friend_subs_list_entry'] * memcfg.node_max_friendships
    total += memcfg.node_friend_max_total_cache * memsizes['friend_queue_entry']
    total += memcfg.node_friend_max_total_cache * memsizes['191'] # max adv extension packet
    total +=  memcfg.node_max_friendships * memsizes['mesh_friend_timer']
    total += memsizes['lc_client_state'] + memsizes['lc_server_state'] +  memsizes['lc_setup_server_state']
    total += memsizes['scene_client_state'] + memsizes['scene_client_state'] +  memsizes['scene_setup_server_state']
    return total
